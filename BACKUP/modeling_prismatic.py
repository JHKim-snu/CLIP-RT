# jhkim/data/clipRT/openvla/prismatic/extern/hf/processing_prismatic.py
...
mynorm_path = "/home/jhkim/tensorflow_datasets/clip_rt_point/1.0.0/dataset_statistics_5d8a7de5a29acfff5c820bbd36b38f19e484e7da52210ae89970a2d97c288ea5.json"
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def predict_action(
        ...
        # Run VLA inference
        if unnorm_key == 'clip_rt':
            generated_ids = self.generate(input_ids, max_new_tokens=7)
        else:
        ...
        # Unnormalize actions
        if unnorm_key == "clip_rt":
            with open(mynorm_path, 'r') as f:
                mynormstat = json.load(f)
            action_norm_stats = mynormstat['action']
        else:

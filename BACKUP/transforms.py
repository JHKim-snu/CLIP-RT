# jhkim/data/clipRT/openvla/prismatic/vla/datasets/rlds/oxe/transforms.py
...
def clip_rt_example_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # nothing to change for our tragectory
    return trajectory

def clip_rt_point_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # nothing to change for our tragectory
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "clip_rt_point": clip_rt_point_dataset_transform,
